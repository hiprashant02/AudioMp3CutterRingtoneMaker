...
object FileUtils {
    ...
    fun getAudioFromUri(context: android.content.Context, uri: android.net.Uri): com.audio.mp3cutter.ringtone.maker.data.model.AudioModel? {
            ...
            context.contentResolver.query(uri, projection, null, null, null)?.use { cursor ->
                if (cursor.moveToFirst()) {
                    ...
                    if (cachedFile != null) {
                         ...
                         audioModel = com.audio.mp3cutter.ringtone.maker.data.model.AudioModel(
